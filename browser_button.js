...
/*
 * Создание кнопки расширения, которая отображается на панели расширений браузера
 * 
 * @_onClicked обрабатывает события при нажатии на иконку
 * @_initDetails инициализация свойств
 * @setTooltipText задает тултип
 * @setCaption задает тултип
 * @setIcon задает иконку
 * @setBadgeValue задает значек
 * @setBadgeBackgroundColor задает цвет бекграунда
 */
